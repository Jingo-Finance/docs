...
Below is the technical reference for the staker contract, [`JingoV3Staker.sol`](https://github.com/Jingo-Finance/v3-staker/blob/main/contracts/JingoV3Staker.sol). A technical guide for interacting with this staking contract will be released soon.
...
```solidity
  function constructor(
    contract IJingoV3Factory _factory,
...
| Name                          | Type                                 | Description                                                                  |
| :---------------------------- | :----------------------------------- | :--------------------------------------------------------------------------- |
| `_factory`                    | contract IJingoV3Factory           | the Jingo V3 factory                                                       |
...
| Name     | Type                                 | Description                                   |
| :------- | :----------------------------------- | :-------------------------------------------- |
| `key`    | struct IJingoV3Staker.IncentiveKey | Details of the incentive to create            |
...
| Name  | Type                                 | Description                     |
| :---- | :----------------------------------- | :------------------------------ |
| `key` | struct IJingoV3Staker.IncentiveKey | Details of the incentive to end |
...
| Name      | Type                                 | Description                                         |
| :-------- | :----------------------------------- | :-------------------------------------------------- |
| `key`     | struct IJingoV3Staker.IncentiveKey | The key of the incentive for which to stake the NFT |
...
| Name      | Type                                 | Description                                           |
| :-------- | :----------------------------------- | :---------------------------------------------------- |
| `key`     | struct IJingoV3Staker.IncentiveKey | The key of the incentive for which to unstake the NFT |
...
| Name      | Type                                 | Description              |
| :-------- | :----------------------------------- | :----------------------- |
| `key`     | struct IJingoV3Staker.IncentiveKey | The key of the incentive |
