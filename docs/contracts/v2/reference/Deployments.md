...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------ | -------------------------------------------- |
| [JingoV3Factory](https://github.com/Jingo-Finance/v3-core/blob/v1.0.0/contracts/JingoV3Factory.sol)                                                    | `0x1F98431c8aD98523631AE4a59f267346ea31F984`           | `0xAfE208a311B21f13EF87E33A90049fC17A7acDEc` |
...
Every Jingo pool is a unique instance of the `JingoV3Pool` contract and is deployed at its own unique address. The contract source code of the pool will be auto-verified on etherscan. For example, here is the [ETH/USDC 0.3% pool](https://etherscan.io/address/0x8ad599c3a0ff1de082011efddc58f1908eb6e6d8) on Ethereum mainnet.

You can look up the address of an existing pool on [Jingo Info](https://info.jingo.finance/#/) or by calling the [`getPool`](../reference/core/interfaces/IJingoV3Factory.md#getpool) function on the `JingoV3Factory` contract.
