...
Below we have the complete functioning code example: a contract that can custody Jingo V3 position NFT's and manipulate the positions and liquidity therein by collecting fees, increasing or decreasing liquidity, and minting new positions. View on github [here](https://github.com/Jingo-Finance/docs/blob/main/examples/smart-contracts/LiquidityExamples.sol).
...
import '@jingofi/v3-core/contracts/interfaces/IPegasysV3Pool.sol';
