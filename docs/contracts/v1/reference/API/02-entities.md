...
The Jingo Factory entity is responsible for storing aggregate information across all Jingo pairs. It can be used to view stats about total liquidity, volume, amount of pairs and more. There is only one PegasysFactory entity in the subgraph.
...
| factory              | PegasysFactory      | reference to Jingo factory entity                                                                                 |
