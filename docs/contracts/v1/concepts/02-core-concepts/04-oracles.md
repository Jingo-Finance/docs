...
Other factors, such as network congestion, can reduce the cost of attack. For a more in-depth review of the security of Jingo V1 price oracles, read the [security audit section on Oracle Integrity](https://pegasys.fi/audit.html#org87c8b91).
