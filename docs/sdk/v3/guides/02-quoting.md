...
We get access to the contract's ABI through the [@jingofi/v3-core](https://www.npmjs.com/package/@pollum-io/v3-core) package, which holds the core smart contracts of the Jingo V3 protocol:
...
We get access to the contract's ABI through the [@jingofi/v3-periphery](https://www.npmjs.com/package/@pollum-io/v3-periphery) package, which holds the periphery smart contracts of the Jingo V3 protocol:
